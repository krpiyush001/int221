            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6  col-xl-4 p-b-30">
                        ...
                        <div class="block1 wrap-pic-w">
                            <img style="object-fit:cover;" src="<?php echo e(Voyager::image( $category->image )); ?>" alt="IMG-BANNER">

                            <a href="shop/category/<?php echo e($category->slug); ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <a href="<?php echo e(route('product.show',$product->slug)); ?>"><img src="<?php echo e(Voyager::image( $product->main_image )); ?>" alt="IMG-PRODUCT"></a>
...
<section class="bg0 p-t-23 p-b-140">
    <div class="container">
        ...
        <div class="row isotope-grid">
            ...
            <?php $__currentLoopData = $overview_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-pic hov-img0">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kundanswear-master\resources\views/pages/index.blade.php ENDPATH**/ ?>